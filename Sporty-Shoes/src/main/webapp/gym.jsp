...
<h1>Add New Shoes</h1>
<form action="insertg">
<b>Shoe ID</b> <input type="text" name="gid" style="background-color:HoneyDew;"><br><br>
<b>Shoe Name</b><input type="text" name="gname" style="background-color:HoneyDew;"><br><br>
<b>Shoe Price</b><input type="text" name="gprice" style="background-color:HoneyDew;"><br><br>
<b>Select Size</b>   <select name="gsize" autofocus style="background-color:HoneyDew;">
...
<form action="getallg">
<input type="submit" value="Show Shoes">
</div>
<div id="bg-wrap">
