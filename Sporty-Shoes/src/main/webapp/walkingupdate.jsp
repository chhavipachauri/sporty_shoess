...
<h1>Update Shoes</h1>
<form action="updatew">
<b>Shoe ID &nbsp&nbsp&nbsp</b><input type="text" name="wid" style="background-color:HoneyDew;"><br><br>
<b>Shoe Name &nbsp</b><input type="text" name="wname" style="background-color:HoneyDew;"><br><br>
<b>Shoe Price&nbsp</b><input type="text" name="wprice" style="background-color:HoneyDew;"><br><br>
<b>Select Size &nbsp&nbsp&nbsp </b>  <select name="wsize" autofocus style="background-color:HoneyDew;">
...
<form action="getallw">
<input type="submit" value="Show Walking Shoes">
</div>
<div id="bg-wrap">
