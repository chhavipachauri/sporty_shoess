...
<h1>Update Shoes</h1>
<form action="insertr">
<b>Shoe ID &nbsp&nbsp&nbsp</b><input type="text" name="rid" style="background-color:HoneyDew;"><br><br>
<b>Shoe Name &nbsp</b><input type="text" name="rname" style="background-color:HoneyDew;"><br><br>
<b>Shoe Price&nbsp</b><input type="text" name="rprice" style="background-color:HoneyDew;"><br><br>
<b>Select Size &nbsp&nbsp&nbsp </b>  <select name="rsize" autofocus style="background-color:HoneyDew;">
...
<form action="getallr">
<input type="submit" value="Show Running Shoes">
</div>
<div id="bg-wrap">
