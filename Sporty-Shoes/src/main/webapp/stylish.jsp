...
<h1>Add New Shoes</h1>
<form action="inserts">
<b>Shoe ID</b> <input type="text" name="sid" style="background-color:HoneyDew;"><br><br>
<b>Shoe Name</b><input type="text" name="sname" style="background-color:HoneyDew;"><br><br>
<b>Shoe Price</b><input type="text" name="sprice" style="background-color:HoneyDew;"><br><br>
<b>Select Size</b>   <select name="ssize" autofocus style="background-color:HoneyDew;">
