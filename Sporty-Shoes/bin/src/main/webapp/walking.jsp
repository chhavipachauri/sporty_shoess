...
<h1>Add New Shoes</h1>
<form action="insertw">
<b>Shoe ID </b><input type="text" name="wid" style="background-color:HoneyDew;"><br><br>
<b>Shoe Name</b><input type="text" name="wname" style="background-color:HoneyDew;"><br><br>
<b>Shoe Price</b><input type="text" name="wprice" style="background-color:HoneyDew;"><br><br>
<b>Select Size </b>  <select name="wsize" autofocus style="background-color:HoneyDew;">
