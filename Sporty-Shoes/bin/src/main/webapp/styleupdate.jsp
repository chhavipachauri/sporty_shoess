...
<h1>Update Shoes</h1>
<form action="updates">
<b>Shoe ID &nbsp&nbsp&nbsp</b><input type="text" name="sid" style="background-color:HoneyDew;"><br><br>
<b>Shoe Name &nbsp</b><input type="text" name="sname" style="background-color:HoneyDew;"><br><br>
<b>Shoe Price&nbsp</b><input type="text" name="sprice" style="background-color:HoneyDew;"><br><br>
<b>Select Size &nbsp&nbsp&nbsp </b>  <select name="ssize" autofocus style="background-color:HoneyDew;">
...
<form action="getalls">
<input type="submit" value="Show Stylish Shoes">
</div>
<div id="bg-wrap">
