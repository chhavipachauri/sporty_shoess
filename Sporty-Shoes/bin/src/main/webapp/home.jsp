...
<div class="content">
<h1><b><font color="red">  Select Category To Browse </font></b></h1><br><br>
<form action="running.jsp">
<input type="submit" value="Running Shoes" >
</form>&nbsp&nbsp
<form action="walking.jsp">
<input type="submit" value="Walking Shoes" >
</form>&nbsp&nbsp
<form action="gym.jsp">
<input type="submit" value="GYM Shoes" >
</form>&nbsp&nbsp
<form action="stylish.jsp">
<input type="submit" value="Stylish Shoes" >
</form>&nbsp&nbsp
</div>
